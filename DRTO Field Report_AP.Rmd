...
*Im having troubling figuring out how to save this in the project folder like its there now but it wont reference it 
...
dataAny$DateTime <- lubridate::with_tz(dataAny$date, "America/New_York")
...
joinedPhTilt<-merge(pH,dataAny, by.x="DateTime", by.y = "DateTime")
...
```{r tilt ph temp stacked,echo=FALSE, fig.width = 12, fig.height = 11}



# line plot (Current Speed)
currentline<-ggplot(data = dataAny) +
