...
* Subsurface **temperature** recorders (STRs) were recovered and redeployed at all 4 study sites, accounting for 1.1 million temperature observations:
...
```{r Diurnal_SuPlotv1, echo=FALSE, warning=FALSE, fig.width = 9,fig.height = 7}
...
```{r SASs, echo=FALSE, out.width = '50%', fig.cap="Submergered Automated Samplers (SAS) deployed to collect water samples every 3 hours", fig.align='center'}
